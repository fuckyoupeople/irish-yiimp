...
// Yenten Coin Comunitty - 2019 - http://yentencoin.info
static const yespower_params_t yespowerR16 = {YESPOWER_1_0, 4096, 16, NULL, 0};
...
{
	if (yespower_tls(input, 80, &yespowerR16, (yespower_binary_t *)output))
		abort();
}
